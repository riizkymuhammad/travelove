            ...
            <div class="panel panel-profile">
                <div class="clearfix">
                    ...
                    <div class="profile-left">
                        ...
                        <div class="profile-header">
                            ...
                            <div class="profile-main">
                                ...
                                <h3 class="name">{{$wisata->nama_wisata}}</h3>
                        ...
                        <div class="profile-detail">
                            <div class="profile-info">
                                ...
                                <ul class="list-unstyled list-justify">
                                    <li>Jenis Wisata <span>{{$wisata->jenis_wisata}}</span></li>
                                    <li>Nomer hp <span>{{$wisata->nomer_hp}}</span></li>
                                    <li>Lokasi <span>{{$wisata->lokasi}}</span></li>
                            ...
                            <div class="text-center"><a href="/wisata/{{$wisata->id}}/edit" class="btn btn-warning">Edit</a></div>
                        </div>
                        <!-- END PROFILE DETAIL -->
                    </div>
                    <!-- END LEFT COLUMN -->
                    ...
                    <div class="profile-right">
                        <h4 class="heading">Our servis </h4>
                        <!-- AWARDS -->
                        <div class="awards">
                            <div class="row">
                        ...
                        <div class="custom-tabs-line tabs-line-bottom left-aligned">
                            <ul class="nav" role="tablist">
                                <li class="active"><a href="#tab-bottom-left1" role="tab" data-toggle="tab">Ourly Activity</a></li>
