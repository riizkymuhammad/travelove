...
<head>
    ...
    <Link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/css/daftar.css') }}">

    <title>Travelove</title>
</head>

<body>
    <img class="center" src="{{ ('admin/flower.png') }}">
    <img class="hehe" src="{{ ('admin/flower.png') }}">
    <div class="container">
        <div class="row">
                ...
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form class="form-signin" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-label-group">
                                <input type="date" name="tgllahir" class="form-control" placeholder="Tanggal Lahir" required autofocus>

                            </div>

                            <h10 style="font-size:14px;" class="card-title text-center">Alamat Lengkap</h10>
                            <div class="form-label-group">
                                <input type="text" name="alamatu" class="form-control" placeholder="Alamat" required autofocus>
                            ...
                            <br>
                            <a href="{{ route('login') }}"><button style="background-color:#8B0000; border:none;" class="btn btn-lg btn-primary btn-block text-uppercase" type="button">Login</button>
                            </a>
                        </form>
                    </div>
                </div>
